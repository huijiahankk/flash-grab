...
visualDegreeDiameter_out = 10;   
visualDegreeDiameter_in = 10; 
sectorRadius_out_pixel = floor(visualDegreeDiameter_out/2 * pixelPerDegree);
sectorRadius_in_pixel = floor(visualDegreeDiameter_in/2 * pixelPerDegree);
