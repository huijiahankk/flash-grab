...
for trial = 1:trialNumber
    ...
    adjustAngleL = 360/2/sectorNumber;
    adjustAngleR = 360/2/sectorNumber;
    ...
    while respToBeMade  % (GetSecs - trailOnset < testDuration) && respToBeMade  % back.RotateTimes < testDuration %  % &&  respToBeMade
        ...
        %----------------------------------------------------------------------
            ...
            if data.flashTiltDirection(trial,block) == 1  && back.FlagSpinDirecA ==  - 1   % flash tilt right
                ...
                % draw red wedge
                Screen('FillArc',wptr,redcolor,redSectorRectAdjust,back.CurrentAngle + 90 - 2*adjustAngleR,sectorArcAngle);  %  wedgeTiltNow - 360/sectorNumber/2
                Screen('FillArc',wptr,bottomcolor,InnerSectorRectAdjust,back.CurrentAngle + 90 - 2*adjustAngleR,sectorArcAngle); %wedgeTiltNow  - 360/sectorNumber/2
                flashPresentFlag = 1;
            ...
            elseif data.flashTiltDirection(trial,block) == 2  && back.FlagSpinDirecB ==  1   % flash tilt left
                ...
                % draw red wedge
                Screen('FillArc',wptr,redcolor,redSectorRectAdjust,back.CurrentAngle - 90 - 2*adjustAngleL,sectorArcAngle); % wedgeTiltNow - 360/sectorNumber/2
                Screen('FillArc',wptr,bottomcolor,InnerSectorRectAdjust,back.CurrentAngle - 90 - 2*adjustAngleL,sectorArcAngle); % wedgeTiltNow - 360/sectorNumber/2
                flashPresentFlag = 1;
