...
illusion = 'y';
trialNumber = 20;  % total min = 20 try * 2s/try * trial/60 = 8 min 
block = 1;
...
%                 Screen('FillArc',wptr,bottomcolor,InnerSectorRectAdjust,back.CurrentAngle + 90 - 2*adjustAngle,sectorArcAngle); %wedgeTiltNow  - 360/sectorNumber/2
                ...
                Screen('FillArc',wptr,redcolor,redSectorRectAdjust,back.CurrentAngle + 90 - 2*adjustAngle,sectorArcAngle);  %  wedgeTiltNow - 360/sectorNumber/2
                Screen('FillArc',wptr,bottomcolor,InnerSectorRectAdjust,back.CurrentAngle + 90 - 2*adjustAngle,sectorArcAngle); 
                flashPresentFlag = 1;
...
%                     WaitSecs(0.5);
    ...
    data.wedgeMoveDegreeMat(block,trial) = wedgeTiltNow;
    WaitSecs (1);
    
end


<<<<<<< Updated upstream:stimulus/fMRI_wedge_illusion_size_behavior_1degree.m
=======
...
>>>>>>> Stashed changes:stimulus/old_edition/realtime_adjust_behavior_illusion_size.m
...
if sectorRadius_in_out_magni == 1
    savePath = '../data/7T/illusionSize_vertical_adjust/small/';
else
    savePath = '../data/7T/illusionSize_vertical_adjust/magnification/';
end
