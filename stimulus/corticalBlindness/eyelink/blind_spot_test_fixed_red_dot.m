% test the right eye blind spot using an flashed red dot
% '1' for red dot moving rightward  '2' for red dot moving leftward
% At the beginning of each trial the fixation should within
% "gaze_away_visual_degree"  then the trial could begin
% The participant in the odd trial move the red dot until invisible
% in the even trial move the red dot until visible
% 20230117 Jiahan Hui
