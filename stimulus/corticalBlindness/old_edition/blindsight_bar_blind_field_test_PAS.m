...
visualDegreeOrig = 10;
visualHeightIn7T_cm_perVisualDegree = tan(deg2rad(1)) * 75;
...
outpara = 20;
inpara = 100;
sectorRadius_in_out_magni = 2; % 2 for other patient
...
visualHeightIn7T_pixel = visualHeightIn7T_pixel_perVisualDegree * visualDegree;
  % inner diameter of background annulus
sectorRadius_out_pixel = floor((visualHeightIn7T_pixel - outpara)/2);%  %         annnulus outer radius
sectorRadius_in_pixel = sectorRadius_out_pixel - inpara * sectorRadius_in_out_magni;  
...
dotColor = [255 0 0];
barWidth = 20;
barLength = 100;  % (sectorRadius_out_pixel - sectorRadius_in_pixel);
...
if dotOrWedgeFlag == 'd'
    savePath = '../../data/corticalBlindness/dot/blindField/';
elseif dotOrWedgeFlag == 'b'
