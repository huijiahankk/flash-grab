...
for block = 1 : blockNumber
    ...
    for trial = 1:trialNumber
        ...
        data.flashTiltDirection(block,trial) = barTiltNow;
        ...
        while 1
            ...
            while respToBeMade
                ...
                if back.CurrentAngle >= back.ReverseAngle  - barTiltNow  % + wedgeTiltNow - (360/sectorNumber/2 + 0.75 + adjustAngle)
                    back.SpinDirec = - 1;
                    back.FlagSpinDirecA = back.SpinDirec;
                    % tilt left
                elseif back.CurrentAngle <= - back.ReverseAngle - barTiltNow  %  + wedgeTiltNow - (360/sectorNumber/2 + 0.75 + adjustAngle)
                    back.SpinDirec = 1;
...
%                 Screen('DrawLines', wptr, allCoords, LineWithPix, blackcolor, [x y]);
                Screen('Flip',wptr);
