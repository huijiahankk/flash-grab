function [timepoint,stim_type,SOA,VarName4,stim_name] = read_optseq2_data(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIMEPOINT,STIM_TYPE,SOA,VARNAME4,STIM_NAME] = IMPORTFILE(FILENAME)
...
%
% Example:
%   [timepoint,stim_type,SOA,VarName4,stim_name] = importfile('par-001.par',1, 48);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/03/14 23:19:53
...
timepoint = dataArray{:, 1};
stim_type = dataArray{:, 2};
SOA = dataArray{:, 3};
VarName4 = dataArray{:, 4};
stim_name = dataArray{:, 5};
